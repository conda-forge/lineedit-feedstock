...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lineedit-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11832&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lineedit-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lineedit` can be installed with:

```
conda install lineedit
```

It is possible to list all of the versions of `lineedit` available on your platform with:
